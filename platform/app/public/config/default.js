  ...
  oidc: [
    {
      // ~ REQUIRED
      // Authorization Server URL
      authority: 'http://localhost/keycloak/realms/ohif', // 'https://aiims.triveous.tech/kc/realms/midas',
      client_id: 'ohif_viewer', //'dashboard',
      redirect_uri: '/callback',
      response_type: 'id_token token',
  ...
  dataSources: [
    {
      ...
      sourceName: 'dicomweb',
      configuration: {
        friendlyName: 'dcm4chee-arc !!!',
        name: 'aws',
        wadoUriRoot: 'https://localhost/dcm4chee-arc/aets/DCM4CHEE/wado',
        qidoRoot: 'https://localhost/dcm4chee-arc/aets/DCM4CHEE/rs',
        wadoRoot: 'https://localhost/dcm4chee-arc/aets/DCM4CHEE/rs',
